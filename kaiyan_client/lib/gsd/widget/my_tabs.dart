...
//todo  更改高度
const double _kmyTabHeight = 150.0;
const double _kmyTextAndIconTabHeight = 165.0;
...
class MyTab extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (icon == null) {
      ...
      //todo _kTabHeight
      height = _kmyTextAndIconTabHeight;
      label = Column(
    ...
    for (Widget item in tabs) {
      if (item is MyTab) {
        ...
        if (tab.text != null && tab.icon != null)
          //todo _kTabHeight
          return Size.fromHeight(_kmyTextAndIconTabHeight + indicatorWeight);
      }
    }
    //todo _kTabHeight
    return Size.fromHeight(_kmyTabHeight + indicatorWeight);
  }
...
class _TabBarState extends State<MyTabBar> {
  ...
  Widget build(BuildContext context) {
    ...
    if (_controller.length == 0) {
      return Container(
        //todo _kTabHeight
        height: _kmyTabHeight + widget.indicatorWeight,
      );
    }
