    ...
    return new Expanded(
        child: new Center(
            child: new RawMaterialButton(
              ...
              child: new GSYIConText(icon, text, GSYConstant.smallSubLightText, Color(GSYColors.subLightTextColor), 15.0,
                  padding: 3.0, mainAxisAlignment: MainAxisAlignment.center)
    )));
  }
